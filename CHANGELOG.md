...
- [FIX] Add missing appProtocol field to ContainerPort (#10) (61cafb1)

## [0.6.0] - 2026-03-26

### Changes

- [FEAT] Warn on unknown fields passed to KubeModel subclasses (#9) (9f869b7)

## [0.5.0] - 2026-02-24

### Changes

- [FEAT] Add TopologySpreadConstraint model to PodSpec (#8) (63d36a6)

## [0.4.1] - 2026-01-07

### Changes

- [DOCS] Document ResourceBuilder and KubeModel for custom resources (#7) (f4387c3)

## [0.4.0] - 2026-01-07

### Changes

- [FEAT] Add generic ResourceBuilder for custom Kubernetes resources (#6) (449bc42)
